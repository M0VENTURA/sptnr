...
Welcome to the SPTNR documentation! This guide will help you navigate all available documentation.
...
- [Dashboard & Overview](FEATURES_DASHBOARD.md) - Dashboard features and statistics
- [Artists & Albums](FEATURES_LIBRARY.md) - Library browsing and management
- [Downloads Manager](FEATURES_DOWNLOADS.md) - Download integration (qBittorrent, Soulseek)
- [Playlist Management](FEATURES_PLAYLISTS.md) - Playlist creation and management
- [Smart Playlists](SPOTIFY_PLAYLIST_IMPORT.md) - Spotify playlist import
- [Bookmarks](BOOKMARK_DROPDOWN_FEATURE.md) - Quick access to favorite items

## ⚙️ Configuration

- [Multi-User Configuration](MULTI_USER_CONFIG_GUIDE.md) - Setting up multiple users
- [Beets Integration](BEETS_INTEGRATION_PLAN.md) - Beets music tagger integration
- [Quick Reference](QUICK_REFERENCE.md) - Common configuration tasks
...
- **Features**: See sections under "Core Features" above
...
- 🎯 = Core feature or important topic
- ⚙️ = Configuration or settings
- 🔧 = Advanced or technical
- 🐛 = Troubleshooting or fixes
