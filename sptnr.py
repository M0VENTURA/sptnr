...
for track in raw_tracks:
    ...
    single_status = detect_single_status(track["title"], artist_name, single_cache, force=force, album_track_count=len(albums_grouped.get(track["album"], [])))
    ...
    if track["is_single"] and track["single_confidence"] == "high":
        ...
        # Optional: slight boost for medium confidence
