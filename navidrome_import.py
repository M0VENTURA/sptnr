    ...
    try:
        ...
        for alb_idx, alb in enumerate(albums, 1):
            ...
            try:
                ...
                log_debug(f"API Response: fetch_album_tracks returned {len(tracks)} tracks for album_id={album_id}, album_artist='{album_artist_from_api}'")
            except Exception as e:
            ...
            album_artist_value = album_artist_from_api or alb.get("artist") or artist_name
