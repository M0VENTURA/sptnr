...
this SPTNR fork is a music rating engine that blends Spotify and Last.fm popularity data, normalizes scores within each artist’s catalog, and outputs star ratings for Navidrome.  This can be used for better automated playlist generation to have playlists based on top tracks.
