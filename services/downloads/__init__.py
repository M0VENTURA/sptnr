...
_EXPORTS: dict[str, str] = {
    ...
    "apply_musicbrainz_match": ".download_matching_service",
    "get_release_status": ".download_matching_service",
    "get_release_tracks": ".download_matching_service",
    "check_folder_duplicates": ".download_folder_service",
    "process_album_existing": ".download_folder_service",
